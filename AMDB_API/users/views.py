...
# To post in user create Endpoint.
@api_view(['POST'])
...
# Function for access token validity check.
...
# To post in create a movie Endpoint.
@api_view(["POST"])
...
# Endpoint to posi in Review a Movie.
@api_view(["POST"])
